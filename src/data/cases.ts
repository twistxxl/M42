...
export const cases: CaseItem[] = [
  ...
  },
  {
    ...
    fullTask:
      'Вокруг любого университета — кафе, барбершопы, репетиторы, курсы. Всем нужны студенты. Но студент не читает листовки у входа и не замечает баннеры. Он живёт в телефоне. Нужна была платформа которую студент откроет сам — а бизнес получит к нему прямой доступ через рекламу.',
    done: [
